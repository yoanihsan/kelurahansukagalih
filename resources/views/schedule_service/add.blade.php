        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <form action="/schedule-service/create" method="post">
                    {{ csrf_field() }}
                    <input class="form-control" type="hidden" name="service" value="Penerbitan KTP">
                    <input class="form-control" type="hidden" name="service_id" value="1">
        ...
        <div class="container" data-aos="fade-up">
          <div class="row">
            <div class="col-lg-12 pt-4 pt-lg-0 content" data-aos="fade-right">
              <h4>Persyaratan</h4>
              <ul>
                <li><i class="icofont-check-circled"></i> Telah berusia 17 Tahun</li>
                <li><i class="icofont-check-circled"></i> Surat Pengantar RT/RW</li>
                <li><i class="icofont-check-circled"></i> Foto Copy Kartu Keluarga</li>
                <li><i class="icofont-check-circled"></i> Foto Copy Kutipan Akta Nikah/Akta Kawin Penduduk yang belum berusia 17 Tahun</li>
                <li><i class="icofont-check-circled"></i> Foto Copy Kutipan Akta Kelahiran</li>
